...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("ogboriauphienkelvin@gmail.com");
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-6 h-full">
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext"> Hi, I'm Kelvin</p>
                ...
                <div className="col-span-1 xl:row-span-4">
                    <div className="grid-container">
                        ...
                        <div className="">
                            ...
                            <p className="grid-subtext">I'm based in Sweden with remote work available</p>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-lg md:text-xl font-medium text-gray_gradient text-white">Ogboriauphienkelvin@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
